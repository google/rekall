...
class XP2003x86BaseVTypes(obj.ProfileModification):
    ...
    vtypes_xp_32 = {
        ...
        'tagCLIP' : [ 12, {
        'fmt' : [ 0, ['Enumeration', dict(target = 'unsigned long', choices = constants.CLIPBOARD_FORMAT_ENUM)]],
        ...
        'bType': [ 8, ['Enumeration', dict(target = 'unsigned char', choices = constants.HANDLE_TYPE_ENUM)]],
    ...
    vtypes_xp_64 = {
        ...
        # From Windows 7
        'tagCLIP' : [ 0x18, {
        'fmt' : [ 0x0, ['Enumeration', dict(target = 'unsigned long', choices = constants.CLIPBOARD_FORMAT_ENUM)]],
        ...
        'bType': [ 0x10, ['Enumeration', dict(target = 'unsigned char', choices = constants.HANDLE_TYPE_ENUM)]],
        ...
        'flags': [ 0x40, ['Flags', {'bitmap': constants.HOOK_FLAGS}]],
        'ihmod' : [ 0x44, ['long']],
