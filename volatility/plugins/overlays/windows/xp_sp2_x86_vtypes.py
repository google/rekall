nt_types = {
  ...
  '_ETHREAD' : [ 0x258, {
    ...
    'NestedFaultCount' : [ 0x1c0, ['BitField', dict(start_bit = 0, end_bit = 2)]],
    'ApcNeeded' : [ 0x1c0, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    ...
    'Terminated' : [ 0x248, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'DeadThread' : [ 0x248, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'HideFromDebugger' : [ 0x248, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'ActiveImpersonationInfo' : [ 0x248, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'SystemThread' : [ 0x248, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'HardErrorsAreDisabled' : [ 0x248, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'BreakOnTermination' : [ 0x248, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'SkipCreationMsg' : [ 0x248, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'SkipTerminationMsg' : [ 0x248, ['BitField', dict(start_bit = 8, end_bit = 9)]],
    'SameThreadPassiveFlags' : [ 0x24c, ['unsigned long']],
    'ActiveExWorker' : [ 0x24c, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'ExWorkerCanWaitUser' : [ 0x24c, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'MemoryMaker' : [ 0x24c, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'SameThreadApcFlags' : [ 0x250, ['unsigned long']],
    'LpcReceivedMsgIdValid' : [ 0x250, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'LpcExitThreadCalled' : [ 0x250, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'AddressSpaceOwner' : [ 0x250, ['BitField', dict(start_bit = 2, end_bit = 3)]],
  ...
  '_EPROCESS' : [ 0x260, {
    ...
    'HasPhysicalVad' : [ 0x248, ['BitField', dict(start_bit = 9, end_bit = 10)]],
    ...
    'Unused3' : [ 0x248, ['BitField', dict(start_bit = 22, end_bit = 23)]],
    'Unused4' : [ 0x248, ['BitField', dict(start_bit = 23, end_bit = 24)]],
    'VdmAllowed' : [ 0x248, ['BitField', dict(start_bit = 24, end_bit = 25)]],
    'Unused' : [ 0x248, ['BitField', dict(start_bit = 25, end_bit = 30)]],
    'Unused1' : [ 0x248, ['BitField', dict(start_bit = 30, end_bit = 31)]],
    'Unused2' : [ 0x248, ['BitField', dict(start_bit = 31, end_bit = 32)]],
  ...
  '_MMSUBSECTION_FLAGS' : [ 0x4, {
    ...
    'LargePages' : [ 0x0, ['BitField', dict(start_bit = 9, end_bit = 10)]],
  ...
  '_MMSUPPORT_FLAGS' : [ 0x4, {
    ...
    'WorkingSetHard' : [ 0x0, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'AddressSpaceBeingDeleted' : [ 0x0, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'Available' : [ 0x0, ['BitField', dict(start_bit = 6, end_bit = 16)]],
    'AllowWorkingSetAdjustment' : [ 0x0, ['BitField', dict(start_bit = 16, end_bit = 24)]],
    'MemoryPriority' : [ 0x0, ['BitField', dict(start_bit = 24, end_bit = 32)]],
} ],
  ...
  '_MM_SESSION_SPACE_FLAGS' : [ 0x4, {
    ...
    'Filler0' : [ 0x0, ['BitField', dict(start_bit = 1, end_bit = 4)]],
    'HasWsLock' : [ 0x0, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'DeletePending' : [ 0x0, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'Filler' : [ 0x0, ['BitField', dict(start_bit = 6, end_bit = 32)]],
} ],
  ...
  '_VI_DEADLOCK_NODE' : [ 0x68, {
    ...
    'SequenceNumber' : [ 0x24, ['BitField', dict(start_bit = 2, end_bit = 32)]],
  ...
  '__unnamed_17ae' : [ 0x4, {
    ...
    'Reserved' : [ 0x0, ['BitField', dict(start_bit = 31, end_bit = 32)]],
} ],
  '_MMPFN' : [ 0x18, {
  ...
  '_MMPFNENTRY' : [ 0x4, {
    ...
    'PageColor' : [ 0x0, ['BitField', dict(start_bit = 4, end_bit = 7)]],
    'ParityError' : [ 0x0, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    ...
    'LockCharged' : [ 0x0, ['BitField', dict(start_bit = 15, end_bit = 16)]],
