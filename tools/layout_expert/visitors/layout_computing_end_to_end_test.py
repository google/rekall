...
from rekall.layout_expert.layout import layout
...
class TestLayoutComputingVisitor(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.basic_types = types.get_64bit_types()
    self.types = self.basic_types
    ...
    self.field_collector.layout_computer = self.layout_computer
  ...
  def test_empty_struct(self):
    ...
    self.types.update(self.type_collector.collect_types(program))
    struct_s = self.types['struct s']
    actual = self.layout_computer.compute_layout(struct_s)
  ...
  def test_struct_with_char_and_aligned_2_and_packed_struct_with_char_and_long(
      self,
  ):
    source = """
        struct r {
  ...
  def test_packed_struct_with_long_char_struct_packed_t_packed_and_char_packed(
      self,
  ):
    source = """
        struct r {
  ...
  def test_struct_with_char_7_short_10_and_struct_with_char_5_and_char_5(self):
    source = """
        struct r {
          char x : 5;
          char y : 5;
  ...
  def test_struct_with_char_and_struct_with_char_and_int_t_aligned_1_aligned_2(
      self,
  ):
    source = """
  ...
  def test_struct_with_char_and_struct_with_char_and_int_t_aligned_2_aligned_1(
      self,
  ):
    source = """
  ...
  def test_struct_with_char_1_and_packed_struct_with_short_1_short_and_short_1(
      self,
  ):
    source = """
        struct r {
  ...
  def test_union_with_int_char_and_long_42(
      self,
  ):
    source = """
        union u {
    ...
    program = self.parser.parse(source)
    self.types.update(self.type_collector.collect_types(program))
    union_u = self.types['union u']
    actual = self.layout_computer.compute_layout(union_u)
    expected = layout.Layout(
        bit_size=64,
        bit_alignment=64,
        fields=[
  ...
  def test_compute_layout_sets_array_evaluated_length_field(self):
    ...
    self.layout_computer.compute_layout(element)
