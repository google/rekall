...
class Layout(_LayoutNode):
  ...
  def __init__(self, bit_size, bit_alignment, fields=None, bit_field=False):
    ...
    Args:
      ...
      fields: a list of CField objects representing the fields nested inside of
        a type.
      bit_field: a bool indicating weather a field is as a BitField.
    """
...
class ArrayLayout(_LayoutNode):
  ...
  def __init__(self, bit_size, bit_alignment, length, member_layout):
    ...
    Args:
      ...
      member_layout: a Layout object to represent the layout of one field of an
        array.
    """
